    ...
    const handleSubmit = async(e)=>{
        ...
        try{
            ...
            const parseData = propertySchema.parse({
                ...
                images: ['placeholder'] // Add placeholder to pass validation since we're not updating images
            });

            // it is used to send mixed data i.e text + numbers + arrays + objects
            ...
            */
            for (const key in parseData) {
                if (key === 'location' || key === 'rates' || key === 'seller_info') {
                    ...
                    // Skip images in edit form as we're not updating them
                    continue;
                } else {
